...
function NetworkCard(){
    return(
        <div>
            <Card img="" title="ARP" description="Notes about the ARP protocol"/>
            <Card img="" title="DHCP" description="Notes about the DHCP protocol"/>
            <Card img="" title="DNS" description="Notes about the DNS protocol"/>
